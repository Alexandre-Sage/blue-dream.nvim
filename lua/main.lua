...
local main = lush(function(f)
  return {
    ...
    -- TabLine(colors.blue2_fg), -- Tab pages line, not active tab page label
    -- TabLineFill(colors.blue2_fg), -- Tab pages line, where there are no labels
    -- TabLineSel(colors.yellow_fg), -- Tab pages line, active tab page label
