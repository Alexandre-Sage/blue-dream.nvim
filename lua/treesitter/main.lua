...
local spec = lush.extends({ main }).with(function(injected_functions)
  ...
  return {
    ...
    sym("@keyword.coroutine")(colors.blue1_fg),
    ...
    -- sym"@text.todo"         (), -- Todo
    -- sym"@comment"           (), -- Comment
    sym("@punctuation")(colors.purple_fg), -- De
    -- sym"@label"             (), -- Label
    -- sym"@preproc"           (), -- PreProc
    sym("@tag")(colors.yellow_fg), -- Tag
    sym("@tag.builtin")(colors.yellow_fg),
    sym("@tag.delimiter")(colors.blue1_fg),
    sym("@tag.attribute")(colors.blue2_fg),
    sym("@function.method.call")(colors.purple_fg),
